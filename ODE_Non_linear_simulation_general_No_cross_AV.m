function dydt = ODE_Non_linear_simulation_general_No_cross_AV(t,y,N,a,b,Ring_length,V,alpha,k_veh,k_bar,t_a,t_b,t_c)
%{
INPUTS:
...
switch nargin 
    ...
    case 10
        for i=1:2:(2*(N-1)-1)
          dydt(i,1)= y(i+1);
          dydt(i+1,1)= a*((y(i+3) - y(i+1))/(y(i+2) - y(i))^3) + b*(V(y(i+2)-y(i))-y(i+1));
        end
          dydt(2*N-1,1)= y(2*N);
