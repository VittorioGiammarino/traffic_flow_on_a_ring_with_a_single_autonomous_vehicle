function dydt = ODE_Non_linear_simulation_general_PrePrint_white_noise_Review(t,y,N,a,b,Ring_length,V,beta,gamma,t_a,t_b,t_c)
%{
INPUTS:
...
switch nargin 
    ...
    case 9
            ...
            if i == (2*(N-1)-1)
                dydt(i,1)= y(i+1);
                dydt(i+1,1)= awgn(a*((y(i+3) - y(i+1))/(y(i+2) - y(i))^2) + b*(V(y(i+2)-y(i))-y(i+1)),15);
            end
            end
            if (t>1000) && (t<1001)
